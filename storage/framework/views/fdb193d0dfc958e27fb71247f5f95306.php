<?php $__env->startSection('title', 'Login - POSALFADZ'); ?>
...
<div class="login-container">
        ...
        <form action="<?php echo e(route('auth')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control form-control-dark" placeholder="nama@email.com" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
            </div>
    ...
    <p class="text-center mt-4 small text-slate-500" style="color: #64748b;">
        &copy; <?php echo e(date('Y')); ?> ALFADZ Point of Sale System.
    </p>

</div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_ALFADZ-main\resources\views/login.blade.php ENDPATH**/ ?>